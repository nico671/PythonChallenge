public class Main {
  ...
  public static void main(String[] args) {
    //  String testString = "g fmnc wms bgblr rpylqjyrc gr zw fylb. rfyrq ufyr amknsrcpq ypc dmp. bmgle gr gl zw fylb gq glcddgagclr ylb rfyr'q ufw rfgq rcvr gq qm jmle. sqgle qrpgle.kyicrpylq() gq pcamkkclbcb. lmu ynnjw ml rfc spj.";
    ...
    FindUniqueCharacters level3 = new FindUniqueCharacters();
    HashMap<String, Integer> yes = level3.countRecurringCharacters(testString2);
    level3.getKeysFromValue(yes, 1);
